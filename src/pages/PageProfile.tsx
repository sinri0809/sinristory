  ...
  return <main className="profile">
    <section className="dashboard-container">
      <div className="dashboard-wrap">
        <div dashboard-index={0} id="dashboard_category" className="dashboard-content">
        ...
        <div dashboard-index={1} id="dashboard_tree" className="dashboard-content">
          <h2>UX Engineer</h2>
        ...
        <div dashboard-index={2} id="dashboard_visualization" className="dashboard-content">
          데이터 시각화 장소
        </div>

        <div dashboard-index={3} id="dashboard_explanation" className="dashboard-content">
          <p>ux engineer is...</p>
        </div>
      </div>
    </section>
