...
const IconDropdownMore = () => {
  return (
    ...
    >
      ...
      <path
        d="M9.22852 14.4932C9.6285 14.9782 10.3714 14.9782 10.7714 14.4933L14.8363 9.56487C15.3742 8.91263 14.9103 7.92859 14.0648 7.92859H5.93512C5.08965 7.92859 4.6257 8.91263 5.16366 9.56487L9.22852 14.4932Z"
        fill="#DFE2E5"
      />
    </svg>
  );
...
const IconLike = () => {
  return (
    ...
    >
      ...
      <path
        d="M17.5686 9.78222C17.6583 9.93538 17.8225 10.0295 18 10.0295C18.1775 10.0295 18.3417 9.93538 18.4314 9.78222C19.1944 8.47981 21.495 6.12279 24.8818 6.55186C29.2205 7.1015 31.9797 11.5283 31.4311 15.4203C31.0903 17.8382 29.6755 20.1419 27.7518 22.3346C25.8309 24.5244 23.45 26.5519 21.2409 28.432L21.2326 28.439C20.074 29.425 18.9602 30.373 18 31.2741C17.0398 30.373 15.926 29.4251 14.7675 28.4391L14.7591 28.432C12.55 26.5519 10.1691 24.5244 8.24816 22.3346C6.32455 20.1419 4.90969 17.8382 4.56887 15.4203C4.02027 11.5283 6.77954 7.1015 11.1182 6.55186C14.505 6.12279 16.8056 8.47981 17.5686 9.78222Z"
        stroke="white"
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        cy="21"
        r="18"
        fill="url(#paint0_radial_5_50)"
        fillOpacity="0.5"
      />
      <defs>
        <radialGradient
          id="paint0_radial_5_50"
          cx="0"
          cy="0"
          r="1"
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(21 21) rotate(90) scale(18)"
        >
